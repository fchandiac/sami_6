...
export default function NewCustomerDialog(props) {
    ...
    const saveCustomer = () => {
        customers.create(
            ...
            newCustomerData.activity,
            newCustomerData.district.id,
            newCustomerData.city.id,
                    ...
                    <Grid container spacing={1} direction={'column'} pt={1}>
                        ...
                        <Grid item>
                            <Autocomplete
                                ...
                                value={newCustomerData.district.label}
                                onChange={(e, newValue) => {
                                    setNewCustomerData({ ...newCustomerData, district: newValue })
                                }}
                                disablePortal
                        ...
                        <Grid item>
                            <Autocomplete
                                ...
                                onChange={(e, newValue) => {
                                    setNewCustomerData({ ...newCustomerData, city: newValue })
                                }}
                                disablePortal
...
function newCustomerDataDefault() {
    return {
        rut: '',
        name: '',
        activity: '',
        address: '',
        city: { id: 0, label: '', key: 0, region_id: 0 },
        district: { id: 0, label: '', key: 0, region_id: 0 },
    }
}
